drop type if exists action_type, dragon_characteristic,cage_type,color,day_time,dragon_status,gender,season,transfer_type,terrain,worker_type,size cascade;
...
tamer_outing,tamer_outing_history,taming_stage,things,transfer_dragon_history,transfer_dragon_results,use_things,workers;
